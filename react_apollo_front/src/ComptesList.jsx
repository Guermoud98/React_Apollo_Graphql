...
const styles = {
  container: {
    ...
    backgroundColor: '#2c3e50', // Fond sombre avec une teinte bleue
  ...
  card: {
    backgroundColor: '#34495e', // Carte sombre avec un ton gris-bleu
    borderRadius: '8px',
    padding: '15px',
  ...
  cardHeading: {
    fontSize: '1.5rem',
    color: '#1abc9c', // Titre de la carte en vert menthe
    marginBottom: '10px',
  },
  deleteButton: {
    marginTop: '10px',
    padding: '10px 15px',
    color: '#fff',
    backgroundColor: '#e74c3c', // Rouge pour supprimer
    border: 'none',
    borderRadius: '5px',
    cursor: 'pointer',
  },
  ...
  modalOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundColor: 'rgba(0, 0, 0, 0.7)', // Overlay légèrement moins sombre
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
  },
  modal: {
    backgroundColor: '#34495e', // Modal sombre
    padding: '20px',
    borderRadius: '8px',
    textAlign: 'center',
  ...
  cancelButton: {
    padding: '10px 15px',
    color: '#fff',
    backgroundColor: '#95a5a6', // Gris pour annuler
    border: 'none',
    borderRadius: '5px',
    cursor: 'pointer',
  },
  confirmButton: {
    padding: '10px 15px',
    color: '#fff',
    backgroundColor: '#27ae60', // Vert pour confirmer
    border: 'none',
    borderRadius: '5px',
    cursor: 'pointer',
  },
